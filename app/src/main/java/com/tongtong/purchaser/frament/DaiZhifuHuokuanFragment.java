...
public class DaiZhifuHuokuanFragment extends BaseFrament implements RecyclerArrayAdapter.OnLoadMoreListener,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Mydivider dividerItemDecoration=new Mydivider(getResources().getColor(R.color.line_color),UIUtil.dip2px(getActivity(),10f));
        dividerItemDecoration.setDrawHeaderFooter(false);
