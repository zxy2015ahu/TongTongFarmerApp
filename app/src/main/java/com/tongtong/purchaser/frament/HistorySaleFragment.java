...
public class HistorySaleFragment extends HeaderViewPagerFragment implements View.OnClickListener,
    ...
    private void loadData(){
        ...
        httpTask.execute(UrlUtil.SELECT_HISTORY_RELEASE, dataJson.toString());
    }
    @Override
