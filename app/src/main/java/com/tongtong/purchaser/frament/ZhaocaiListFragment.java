...
public class ZhaocaiListFragment extends BaseFrament implements View.OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.zhaocai_list_fragment,container,false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        handler=new Handler();
        tv_choose_type=view.findViewById(R.id.tv_choose_type);
        tv_choose_guige=view.findViewById(R.id.tv_choose_guige);
        tv_choose_quyu=view.findViewById(R.id.tv_choose_quyu);
        line_guige=view.findViewById(R.id.line1);
        ...
        tv_guige_name=(TextView) view.findViewById(R.id.tv_guige_name);
        tv_quyu_name=(TextView) view.findViewById(R.id.tv_quyu_name);
        paixu_img=(ImageView) view.findViewById(R.id.img);
        ...
        view.findViewById(R.id.paixu).setOnClickListener(this);
        ...
        publishAdapter=new PublishAdapter(getActivity());
        ...
        getActivity().getWindowManager().getDefaultDisplay().getMetrics(dm);
            ...
            tv_type_name.setTextColor(ContextCompat.getColor(getActivity(),R.color.colorPrimary));
        ...
        header=new RecyclerArrayAdapter.ItemView() {
            ...
            public View onCreateView(ViewGroup parent) {
                View view=View.inflate(getActivity(),R.layout.search_empty_header,null);
    ...
    private void showSortPop(){
        if(sortPop==null){
            View container=View.inflate(getActivity(),R.layout.normal_list_view,null);
            ...
            sortPop.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(getActivity(),R.color.city_search_bg)));
    ...
    private void initSortData(View container){
        ...
        sortAdapter=new MySortAdapter(getActivity());
    ...
    private class MySortAdapter extends ArrayAdapter<SortItem>{
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            if(convertView==null){
                convertView=getActivity().getLayoutInflater().inflate(R.layout.checked_text_view,null);
            }
            ...
            if(order==position){
                ...
                title.setTextColor(ContextCompat.getColor(getActivity(),R.color.aliwx_common_text_color2));
            }
            return convertView;
        }
    }
    ...
    private void initGuigePop(JsonArray items){
        if(guigePop==null){
            View container=View.inflate(getActivity(),R.layout.produce_type_layout,null);
            int[] outlocation=new int[2];
            anchor.getLocationOnScreen(outlocation);
            ...
            guigePop.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(getActivity(),R.color.city_search_bg)));
    ...
    private void initGuigeData(View container,JsonArray items){
        ...
        for(int i=0;i<items.size();i++){
            ...
            View produce_item=View.inflate(getActivity(),R.layout.produce_item,null);
            ...
            final TagAdapter tagAdapter=new TagAdapter(getActivity(),tags);
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if(!checked){
                        ...
                        if(selecte_type.size()>=5){
                            StyleableToast.info(getActivity(),"最多选择5个标签");
                            return;
                        }
    ...
    private class TagAdapter extends ArrayAdapter<TagItem>{
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            if(convertView==null){
                convertView=getActivity().getLayoutInflater().inflate(R.layout.guige_item,null);
            }
    ...
    @Override
    public void onClick(View v) {
        if(v.getId()==R.id.tv_choose_type){
            showTypePop();
            ...
            if(guigePop!=null){
                ...
                tv_guige_name.setTextColor(ContextCompat.getColor(getActivity(),R.color.colorPrimary));
    ...
    private void showAdcodePop(){
        ...
        tv_quyu_name.setTextColor(ContextCompat.getColor(getActivity(),R.color.colorPrimary));
    ...
    private void onselectaddress(Region region){
        ...
        if(adcode==0){
            ...
            HistoryHelper.addHistory(getActivity(),select_region);
        }
        onRefresh();
    }
    private void onselecttype(ProduceType produce){
        ...
        if(produce.getLevel()==1){
            ...
            ProduceTypesHelper.addHistotyProduce(getActivity(),produce);
        }else if(produce.getLevel()==3){
            p3=produce.getId();
            ProduceType pt=ProduceTypesHelper.getParentProduce(getActivity(),p3);
            loadGuige(pt.getId());
            //保存搜索历史
            ProduceTypesHelper.addHistotyProduce(getActivity(),produce);
        }else{
