...
public class StyleableToast extends LinearLayout {
    ...
    private static Toast styleableToast;
    ...
    public static void info(@NonNull Context context, String text){
        new StyleableToast(context, text, Toast.LENGTH_SHORT, R.style.info_mytoast).show();
    }
    public static void error(@NonNull Context context, String text){
        new StyleableToast(context, text, Toast.LENGTH_SHORT, R.style.error_mytoast).show();
    }
    public static void warm(@NonNull Context context, String text){
        new StyleableToast(context, text, Toast.LENGTH_SHORT, R.style.warm_mytoast).show();
    }
    public static void success(@NonNull Context context, String text){
        new StyleableToast(context, text, Toast.LENGTH_SHORT, R.style.success_mytoast).show();
    }
...
//        }
    ...
    private void loadShapeAttributes() {
        ...
        cornerRadius = (int) typedArray.getDimension(R.styleable.StyleableToast_cornerRadius, getResources().getDimensionPixelSize(R.dimen.default_corner_radius));
