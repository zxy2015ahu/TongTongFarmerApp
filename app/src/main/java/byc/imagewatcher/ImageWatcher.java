...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener {
    ...
    public void showMultiple(String videoUrl,ImageView i, List<ImageView> imageGroupList, final List<String> urlList) {
        if (loader == null) {
            throw new NullPointerException("please invoke `setLoader` first [loader == null]");
        }
    ...
    class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if(position==0&&videoUrl!=null){
                JZVideoPlayerStandard videoView=new JZVideoPlayerStandard(container.getContext());
